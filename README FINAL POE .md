...
1. The game screen serves as a rewarding system for completing tasks, setting goals, and basic task/project activities.
...
1. A reward system for completing a task (related to coloring therapy).
